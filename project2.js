...
import {
  ...
  // 1. Add variables for smooth sphere movement
  ...
  // 2. Modify the moveCubes function
  function moveCubes(deltaTime) {
    ...
    // Rotate Arm 1 (Left Arm) - now independent of cube
    ...
    // Rotate Arm 2 (Right Arm) - still attached to cube
    ...
    // Update user-controlled sphere position with smooth movement
  ...
  // 3. Update the keydown event listener
